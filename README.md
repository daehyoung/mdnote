...
본 프로젝트는 AI 에디터와 개발자가 긴밀하게 협업하는 **신뢰 기반의 문서 주도 개발(Document-Driven Development)** 프로세스를 따릅니다.

1.  **요구사항 및 설계 요청 (Planning)**: 개발자가 새로운 기능이나 변경 사항을 요청하면, AI는 관련 문서를 먼저 작성하거나 업데이트하여 구현 방향을 제안합니다.
